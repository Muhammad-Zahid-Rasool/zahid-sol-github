        ...
        <div className='container'>
            ...
            <div className='row'>
              <div className='col-lg-5 text-center'>
                <div className='thumb mb-4 mb-lg-0'>
                  <img src='assets/img/team/zahid.png' alt='img' />
                </div>
              </div>
          ...
          <div className='team-details-page'>
            <div className='row'>
              ...
              <div className='col-lg-7 align-self-center ps-xl-5'>
                <h3 className='mb-2'>Muhammad Shahid Rasool</h3>
                <span className='designation'>CEO</span>
                <div className='details mt-4'>
                  <h4>Message from CEO</h4>
                  <p>
                  Our vision is to connect ideas with the power of technology, boosting our clients' competitive pace for their long-term profitability and sustainability.{" "}
                  </p>
                  <p>
                    DJs flock by when MTV ax quiz prog. Junk MTV quiz graced by
                    fox whelps. Bawds jog, flick quartz, vex nymphs. Waltz, bad
